/*
Nom de l'affectation : last_word
Fichiers attendus : last_word.c
Fonctions autorisées : write
--------------------------------------------------------------------------------

Écrivez un programme qui prend une chaîne et affiche son dernier mot, suivi d'un saut de ligne.

Un mot est une section d'une chaîne, séparée par des espaces/tabulations ou le début/la fin d'une ligne.

Si le nombre de paramètres est différent de 1 ou qu'il n'y a aucun mot, affiche un saut de ligne.
*/
